                                                            ...
                                                            <div class="wpb_wrapper">
                                                                ...
                                                                <div class="layer_wrap iq-objects-style-2 "
                                                                     id="object_1959149622"><span
                                                                        ...
                                                                        data-top="transform:translatex(0);">
																				<img src="{{asset("wp-content/uploads/sites/9/2019/02/b3-1.png")}}"
                                                                                     alt="drive02">
																			</span><span class="iq-objects-02"
                                                                                         data-bottom="transform:translatey(-200px)"
                                                                                         data-top="transform:translatex(-0);">
																				<img src="{{asset("wp-content/uploads/sites/9/2019/02/b1-1.png")}}"
                                                                                     alt="drive02">
																			</span></div>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="wpb_wrapper">
                                                                <div
                                                                    ...
                                                                    <img class="img-fluid center-block"
                                                                         src="{{ asset("wp-content/uploads/sites/9/2019/02/video-1.jpg")}}"
                                                                         alt="#">
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <div class="tab-content"
                                                                                ...
                                                                                <div class="tab-pane fade show active"
                                                                                     id="tab11"><img
                                                                                        src="{{asset("wp-content/uploads/sites/9/2019/02/s-1-1.jpg")}}"
                                                                                ...
                                                                                <div class="tab-pane fade show "
                                                                                     id="tab22"><img
                                                                                        src="{{asset("wp-content/uploads/sites/9/2019/02/s-2-1.jpg")}}"
                                                                                        class="img-fluid center-block"
                                                                                        alt="#"></div>
                                                                                ...
                                                                                <div class="tab-pane fade show "
                                                                                     id="tab13"><img
                                                                                        src="{{asset("wp-content/uploads/sites/9/2019/02/s-3-1.jpg")}}"
                                                                                        class="img-fluid center-block"
                                                                                        alt="#"></div>
                                                                                ...
                                                                                <div class="tab-pane fade show "
                                                                                     id="tab24"><img
                                                                                        src="{{asset("wp-content/uploads/sites/9/2019/02/s-4-1.jpg")}}"
                                                                                        class="img-fluid center-block"
                                                                                        alt="#"></div>
                                                                                ...
                                                                                <div class="tab-pane fade show "
                                                                                     id="tab15"><img
                                                                                        src="{{asset("wp-content/uploads/sites/9/2019/02/s-5-1.jpg")}}"
                                                                                        class="img-fluid center-block"
                                                                                        alt="#"></div>
                                                                                ...
                                                                                <div class="tab-pane fade show "
                                                                                     id="tab26"><img
                                                                                        src="{{asset("wp-content/uploads/sites/9/2019/02/s-6-1.jpg")}}"
                                                                                        class="img-fluid center-block"
                                                                                        alt="#"></div>
                                                                    ...
                                                                    <div class="owl-carousel popup-gallery"
                                                                        ...
                                                                        <div class="item"><a
                                                                                ...
                                                                                class="popup-img"><img
                                                                                    ...
                                                                                    alt="#"></a></div>
                                                                        <div class="item"><a
                                                                                href="{{ asset("wp-content/uploads/sites/9/2019/02/s-2-1.jpg")}}"
                                                                                class="popup-img"><img
                                                                                    class="img-fluid"
                                                                                    src="{{ asset("wp-content/uploads/sites/9/2019/02/s-2-1.jpg")}}"
                                                                                    alt="#"></a></div>
                                                            ...
                                                            <div class="wpb_wrapper">
                                                                <div class="col-lg-12 col-md-12">
                                                                    <div class="owl-carousel" data-dots="false"
                                                                        ...
                                                                        <div class="item">
                                                                            <img class="item"
                                                                                 src="{{ asset("wp-content/uploads/sites/9/2019/02/l1-1.png")}}"
                                                                                 alt="client0">
                                                                        </div>
                                                                        <div class="item">
                                                                            <img class="item"
                                                                                 src="{{ asset("wp-content/uploads/sites/9/2019/02/l2-1.png")}}"
                                                                                 alt="client1">
                                                                        </div>
                                                                        <div class="item">
                                                                            <img class="item"
                                                                                 src="{{ asset("wp-content/uploads/sites/9/2019/02/l3-1.png")}}"
                                                                                 alt="client2">
                                                                        </div>
                                                                        <div class="item">
                                                                            <img class="item"
                                                                                 src="{{ asset("wp-content/uploads/sites/9/2019/02/l4-1.png")}}"
                                                                                 alt="client3">
                                                                        </div>
                                                                        <div class="item">
                                                                            <img class="item"
                                                                                 src="{{ asset("wp-content/uploads/sites/9/2019/02/l5-1.png")}}"
                                                                                 alt="client4">
                                                                        </div>
                                                                        <div class="item">
                                                                            <img class="item"
                                                                                 src="{{ asset("wp-content/uploads/sites/9/2019/02/l6-1.png")}}"
                                                                                 alt="client5">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                                ...
                                                                                <form method="post"
                                                                                    ...
                                                                                    <div class="email-form">
                                                                                        ...
                                                                                        <div
                                                                                            ...
                                                                                            <div
                                                                                                class="alax-loader">
                                                                                                <img alt="" src="{{ asset("wp-content/plugins/appino-extensions/subscribers/ajax-loader.gif")}}"
                                                                                                     style="display:none;"
                                                                                                     id="loader"
                                                                                                     class="loading" />
                                                                                            </div>
