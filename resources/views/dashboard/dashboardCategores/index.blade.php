        ...
        <div class="page-header row no-gutters py-4">
            <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
                ...
                <h3 class="page-title"><i class="icon-line-awesome-align-justify"></i> Catégories
                    <a href="{{ route('dashboardCategores.create') }}" class="mb-2 btn btn-success mr-2"><i
                                ...
                                <tbody>
                                    ...
                                    @foreach ($Categores as $Category)
                                        <tr>
                                            ...
                                            <td class="lo-stats__total text-center text-success">{{ $Category->slug }}
                                            </td>
                                            <td class="lo-stats__status">
                                                <div class="d-table mx-auto">
                                                    <span
                                                        class="badge badge-pill badge-{{ $Category->color }}">{{ $Category->color }}</span>
                                                </div>
                                            </td>
                                            <td class="lo-stats__actions">
                                                ...
                                                <div class="btn-group d-table ml-auto" role="group"
                                                    ...
                                                    <a href="{{ URL::to('dashboard/dashboardCategores') }}/{{ $Category->slug }}/edit"
                                                    ...
                                                    <!-- ================================ dashboard Categores store ====================================== -->
                                                    <form
                                                        action="{{ route('dashboardCategores.destroy', $Category->id) }}"
                        ...
                        <div class="row">
                            ...
                            <div class="col text-right view-report">
                                @if (COUNT($Categores) != null)
                                    <a>Afficher 10 à {{ COUNT($Categores) }} de {{ COUNT($Categores) }} catégories</a>
                                @else
