            ...
            <div class="col-lg-9 col-md-12">
                ...
                <div class="card card-small mb-3">
                    <div id="form-container" class="card-body">
                        <!-- ====================== links Posts Content Start store =============================================== -->
                        <form action="{{ route('dashboardPosts.store') }}" method="POST" role="form"
                                ...
                                <div class="col-10">
                                    <div class="tab-content" id="v-pills-tabContent">
                                        {{-- <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel"
                                            ...
                                            <textarea class="form-control form-control-lg mb-3" cols="4" name="body_gr" placeholder="Your Post Content French"></textarea>
                                        </div>
                    ...
                    <div class='card-body p-0'>
                        <ul class="list-group list-group-flush">
                            <div class="edit-post-details__avatar m-auto">
                                <img id="viewer2" src="{{ asset('dashboardassets/images/content-management/cover.png') }}"
                                    alt="User Avatar">
