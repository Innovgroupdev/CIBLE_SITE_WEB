        ...
        <div class="row">
            <div class="col-lg-9 col-md-12">
                ...
                <div class="card card-small mb-3">
                    <div class="card-body">
                        <!-- ====================== links Menu Content Start =============================================== -->
                        <form action="{{ route('dashboardMenus.store') }}" method="POST" role="form"
                            enctype="multipart/form-data" class="add-new-post">
                            @csrf
                            <input class="form-control form-control-lg mb-3" type="text" placeholder="Your Menu Title"
                                name="name">
                    </div>
                    <!-- ====================== links Menu Content Start =============================================== -->
                </div>
                    ...
                    <div class='card-body p-0'>
                        <ul class="list-group list-group-flush">
                            ...
                            <li class="list-group-item d-flex px-3">
                                <a class="btn btn-sm btn-outline-accent" href="{{ url('dashboard/dashboardMenus') }}"><i
                                        class="icon-feather-triangle"></i> Menus</a>
                                <button class="btn btn-sm btn-accent ml-auto" type="submit">
                                    <i class="icon-material-outline-note-add"></i> Publier</button>
                            </li>
                        </ul>
                    </div>
                </div>
