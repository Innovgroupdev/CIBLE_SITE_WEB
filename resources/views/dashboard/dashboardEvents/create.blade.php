            ...
            <div class="col-lg-9 col-md-12">
                ...
                <div class="card card-small mb-3">
                    <div id="form-container" class="card-body">
                        <!-- ================================ links Events Content Start ========================================================================= -->
                        <form action="{{ route('dashboardEvents.store') }}" method="POST" role="form"
                            ...
                            <input class="form-control form-control-lg mb-3" type="text" placeholder="Description"
                                name="slug">
                            {{-- <input class="form-control form-control-lg mb-3" type="text" placeholder="Your Days"
                                name="Days">
                            <input class="form-control form-control-lg mb-3" type="text" placeholder="Your Hours"
                                name="Hours">
                                    ...
                                    <div class="tab-content" id="v-pills-tabContent">
                                        {{-- <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel"
                                            ...
                                            <input class="form-control form-control-lg mb-3" type="text"
                                                placeholder="Your Post Title French" name="Title_en">
                                        ...
                                        <div class="tab-pane fade" id="v-pills-profile" role="tabpanel"
                                            ...
                                            <input class="form-control form-control-lg mb-3" type="text"
                                                placeholder="Your Post Title Arabic" name="Title_ar">
                    ...
                    <div class='card-body p-0'>
                        <ul class="list-group list-group-flush">
                            ...
                            <li class="list-group-item d-flex px-3">
                                <a class="btn btn-sm btn-outline-accent" href="{{ route('dashboardEvents.index') }}"><i
                    ...
                    <div class='card-body p-0'>
                        <ul class="list-group list-group-flush">
                            <div class="edit-post-details__avatar m-auto">
                                <img id="viewer" src="{{ asset('dashboardassets/images/content-management/cover.png') }}"
                                    alt="Event Avatar">
