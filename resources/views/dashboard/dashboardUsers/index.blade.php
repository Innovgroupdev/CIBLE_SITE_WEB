              ...
              <div class="container-fluid px-0">
                <table class="table mb-0">
                  ...
                  <tbody>
                    ...
                    <a href="{{ URL::to('dashboard/dashboardUsers')}}/{{$User->name}}/edit" class="mb-2 btn btn-sm btn-primary"><i class="icon-feather-edit-2"></i> Editer</a>
                    &nbsp
              ...
              <div class="row">
                <div class="col">
                  ...
                  <div class="col text-right view-report">
                    <!-- ============================================= links Content Start User ============================================= -->
                    @if(COUNT($Users) != NULL)
                    <a>Afficher 10 à {{ COUNT($Users) }} de {{ COUNT($Users) }} utilisateurs</a>
                    @else
