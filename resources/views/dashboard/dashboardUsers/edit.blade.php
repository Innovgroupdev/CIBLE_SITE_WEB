                        ...
                        <li class="list-group-item p-3">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <form action="{{ route('dashboardUsers.update', $User->name) }}" method="POST"
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" class="form-control" id="feFirstName"
                                                    placeholder="Nom et prénoms" name="name" value="{{ $User->name }}">
                                            </div>
                                            <div class="form-group col-md-6">
                ...
                <div class="card card-small mb-4 pt-3">
                    <div class="card-header border-bottom text-center" style="border-radius: 10px;">
                        <div class="mb-3 mx-auto">
                            <img src="{{ asset($User->avatar) }}" alt="User Avatar" width="110">
                        </div>
                        <input type="file" name="avatar{{ $errors->has('avatar') ? ' is-invalid' : '' }}"
                            class="btn btn-sm btn-white d-table mx-auto mt-4" value="{{ $User->avatar }}">
                        @if ($errors->any())
