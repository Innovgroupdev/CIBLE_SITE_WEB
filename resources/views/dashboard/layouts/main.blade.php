...
<head>
    ...
    <link rel="apple-touch-icon" sizes="57x57"
        href="{{ asset('dashboardassets/images/favicon/apple-icon-57x57.png') }}">
    <link rel="apple-touch-icon" sizes="60x60"
        href="{{ asset('dashboardassets/images/favicon/apple-icon-60x60.png') }}">
    <link rel="apple-touch-icon" sizes="72x72"
        href="{{ asset('dashboardassets/images/favicon/apple-icon-72x72.png') }}">
    <link rel="apple-touch-icon" sizes="76x76"
        href="{{ asset('dashboardassets/images/favicon/apple-icon-76x76.png') }}">
    ...
    <!-- ============================================= styles SiteTitle ============================================= -->
    <script async defer src="{{ asset('dashboardassets/scripts/customPage.js') }}"></script>
                        ...
                        <a class="navbar-brand w-100 mr-0" href="{{ url('/') }}" style="line-height: 25px;"
                            ...
                            <div class="d-table m-auto">
                                ...
                                <img id="main-logo" class="d-inline-block align-top mr-1 rounded-circle20"
                                    src="{{ asset(Setting()->LogoPicture) }}" style="border-radius: 50%;"
                    ...
                    document.getElementById('logout-form').submit();"
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle text-nowrap px-3" data-toggle="dropdown"
                                    ...
                                    <img class="user-avatar rounded-circle20 mr-2" src="{!! asset(Auth::user()->avatar) !!}"
                                ...
                                <div class="dropdown-menu dropdown-menu-small">
                                    <a class="dropdown-item"
                                        href="{{ url('dashboard/dashboardUsers') }}/{{ Auth::user()->name }}/edit">
                        ...
                        document.getElementById('logout-form').submit();"
                                        ...
                                        <i class=" icon-feather-log-out text-danger"></i> Se déconnecter </a>
                                    <form id="logout-form" action="{{ route('logout') }}" method="POST"
                                        style="display: none;">
                                        @csrf
                                    </form>
