    ...
    <div class="main-content-container container-fluid px-4">
        ...
        <div class="page-header row no-gutters py-4">
            <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
                <span class="text-uppercase page-subtitle">Projets</span>
                <h3 class="page-title"><i class="icon-material-outline-assignment"></i> Modifier un projet</h3>
            </div>
        </div>
        <!-- End Page Header -->
        <div class="row">
                    ...
                    <div class="card-body">
                        ...
                        <form class="add-new-Cause" action="{{ route('dashboardCauses.update', $Cause->slug) }}"
                            ...
                            <input class="form-control form-control-lg mb-3" type="text" placeholder="Donateurs"
                                name="Donors" value="{{ $Cause->Donors }}">
                            <!-- ================================ dashboard Causes update ========================================================================= -->
                            <div class="form-control form-control-lg mb-3">
                                <label for="Category">Catégorie</label>
                                <select class="custom-select" name="category_id">
                                    @if (isset($Cause->Category->title))
                                        <option value="{{ $Cause->category_id }}" selected="">
                                            {{ $Cause->Category->title }}</option>
                                    @else
                            ...
                            <!-- ================================ dashboard Causes update ========================================================================= -->
                            <textarea value="{{ $Cause->Content_en }}" class="form-control form-control-lg mb-3" type="text" name="Content_en"
                                rows="15">
                {{ $Cause->Content_en }}
               </textarea>
                            <!-- ================================ dashboard Causes update ========================================================================= -->
                    ...
                    <a class="nav-link" id="v-pills-profile-tab" data-toggle="pill" href="#v-pills-profile" role="tab" aria-controls="v-pills-profile" aria-selected="false"><img src="{{ asset('dashboardassets/images/arabic.png') }}"> Arabic</a>
                      ...
                      <input class="form-control form-control-lg mb-3" type="text" value="{{ $Cause->Title_en }}" placeholder="Your Cause Title French" name="Title_en">
                      <textarea class="form-control form-control-lg mb-3" value="{{ $Cause->Content_gr }}" cols="4" name="Content_gr" placeholder="Your Cause Content French">{{ $Cause->Content_gr }}</textarea>
                   </div>
                ...
                <span class="d-flex">
                  ...
                  <strong class="text-warning">Ok</strong>
                            ...
                            <li class="list-group-item d-flex px-3">
                                <a class="btn btn-sm btn-outline-accent" href="{{ route('dashboardCauses.index') }}"><i
                    ...
                    <div class='card-body p-0'>
                        <ul class="list-group list-group-flush">
                            <div class="edit-post-details__avatar m-auto">
                                <img id="viewer" src="{!! asset($Cause->image) !!}" alt="Projet image">
                                <label class="edit-post-details__avatar__change">
                                    <i class="material-icons   icon-material-outline-add-a-photo mr-1"></i>
                                    <input type="file" name="image" hidden="" value="{{ $Cause->image }}" id="customFileEg1">
                                </label>
                            </div>
                        </ul>
                        </form>
