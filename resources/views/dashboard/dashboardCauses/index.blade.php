                                        ...
                                        <tr>
                                            ...
                                            <td class="lo-stats__status">
                                                <div class="d-table mx-auto">
                                                    @if (isset($Cause->Category->title))
                                                        <span
                                                            class="badge badge-pill badge-success">{{ $Cause->Category->title }}</span>
                                                    @else
                                            ...
                                            <td class="lo-stats__actions">
                                                <div class="btn-group d-table ml-auto" role="group"
                                                    ...
                                                    <a href="{{ URL::to('dashboard/dashboardCauses') }}/{{ $Cause->slug }}/edit"
                                                        class="mb-2 btn btn-sm btn-primary">

                                                        <i class="icon-feather-edit-2"></i> Editer</a>
                                                    &nbsp
                                                    <form action="{{ route('dashboardCauses.destroy', $Cause->id) }}"
                        ...
                        <div class="row">
                            ...
                            <div class="col text-right view-report">
                                ...
                                @if (COUNT($Causes) != null)
                                    <a>Afficher 10 à {{ COUNT($Causes) }} de {{ COUNT($Causes) }} causes</a>
                                @else
