    ...
    <div class="main-content-container container-fluid px-4" id="editor">
        ...
        <div class="page-header row no-gutters py-4">
            <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
                ...
                <h3 class="page-title"><i class=" icon-material-outline-assignment"></i> Ajouter un projet</h3>
            </div>
        </div>
        <!-- ================================ links Causes Content Start ========================================================================= -->
        <!-- End Page Header -->
            ...
            <div class="col-lg-9 col-md-12">
                ...
                <div class="card card-small mb-3">
                    <div id="form-container" class="card-body">
                        ...
                        <form action="{{ route('dashboardCauses.store') }}" method="POST" role="form"
                            ...
                            <input class="form-control form-control-lg mb-3" type="text" placeholder="Description"
                                name="slug">
                            <input class="form-control form-control-lg mb-3" type="text" placeholder="Recolté"
                                name="Raised">
                            <input class="form-control form-control-lg mb-3" type="text" placeholder="Objectifs"
                                name="Goal">
                            <input class="form-control form-control-lg mb-3" type="number" placeholder="Donateurs"
                                name="Donors">
                            <!-- ================================ dashboard Causes store ========================================================================= -->
                  ...
                  <div class="tab-content" id="v-pills-tabContent">
                   <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                      <input class="form-control form-control-lg mb-3" type="text" placeholder="Your Post Title French" name="Title_en">
                      <textarea class="form-control form-control-lg mb-3" cols="4" name="Content_gr" placeholder="Your Post Content French"></textarea>
                   </div>
                    ...
                    <div class='card-body p-0'>
                        <ul class="list-group list-group-flush">
                            <div class="edit-post-details__avatar m-auto">
                                <img id="viewer"
                                    src="{{ asset('dashboardassets/images/content-management/cover.png') }}"
                                    alt="User Avatar">
