        ...
        <div class="page-header row no-gutters py-4">
            <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
                ...
                <h3 class="page-title"><i class="icon-feather-tv"></i> Ads
                    <a href="{{ route('dashboardAds.create') }}" class="mb-2 btn btn-success mr-2"><i
                                ...
                                <tbody>
                                    ...
                                    @foreach ($advertisers as $advertiser)
                                        <tr>
                                            ...
                                            <!-- ================================ advertisers Content Start ======================== -->
                                            <td class="lo-stats__total text-center text-success">{!! $advertiser->type !!}
                                            </td>
                                            <td class="lo-stats__status">
                                                <div class="d-table mx-auto">
                                                    <span
                                                        class="badge badge-pill badge-success">{!! $advertiser->Location !!}</span>
                                                </div>
                                            </td>
                                            <!-- ================================ advertisers Content Start ======================== -->
                        ...
                        <div class="row">
                            ...
                            <div class="col text-right view-report">
                                @if (COUNT($advertisers) != null)
                                    <a>Afficher 10 to {{ COUNT($advertisers) }} of {{ COUNT($advertisers) }}
                                        advertisers</a>
                                @else
