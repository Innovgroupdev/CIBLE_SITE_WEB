              ...
              <form action="<?php echo e(route('dashboardSettings.update', $Setting->id)); ?>" method="POST" class="py-4" role="form" enctype="multipart/form-data" class="form-horizontal">
                ...
                <div class="form-row mx-4">
                  ...
                  <div class="col-lg-4">
                    ...
                    <!-- ============================================= links Content Start Setting ============================================= -->
                    <input class="btn btn-sm btn-white d-table mx-auto mt-4" type="file" placeholder="Upload Image" name="LogoPicture" value="<?php echo e($Setting->LogoPicture); ?>">
                    <!-- ============================================= links Content Start Setting ============================================= -->
                  </div>
                </div>
                <!-- ============================================= links Content Start Setting ============================================= -->
                ...
                <div class="form-row mx-4">
                  <div class="form-group col-md-4">
                    ...
                    <input class="btn btn-sm btn-white d-table" type="file" name="FaviconOne" placeholder="Upload Image 32x32" value="<?php echo e($Setting->FaviconOne); ?>">
                  </div>
                  <div class="form-group col-md-4">
                    <label for="socialFacebook">Favicon 96x96</label>
                    <input class="btn btn-sm btn-white d-table" type="file" name="FaviconTwo" placeholder="Upload Image 96x96" value="<?php echo e($Setting->FaviconTwo); ?>">
                  </div>
                  <div class="form-group col-md-4">
                    <label for="socialFacebook">Favicon 16x16</label>
                    <input class="btn btn-sm btn-white d-table" type="file" name="FaviconThree" placeholder="Upload Image 16x16" value="<?php echo e($Setting->FaviconThree); ?>">
                  </div>
                </div>
            ...
            <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
              ...
              <div class="form-row mx-4">
                <div class="form-group col-md-4">
                  ...
                  <input class="btn btn-sm btn-white d-table" type="file" name="AboutPicture<?php echo e($errors->has('AboutPicture') ? ' is-invalid' : ''); ?>" placeholder="Upload Image 96x96" value="<?php echo e($Setting->AboutPicture); ?>">
                  <?php if ($errors->any()) : ?>
                ...
                <div class="form-group col-md-4">
                  ...
                  <input class="btn btn-sm btn-white d-table" type="file" name="HomePicture<?php echo e($errors->has('HomePicture') ? ' is-invalid' : ''); ?>" placeholder="Upload Image 96x96" value="<?php echo e($Setting->HomePicture); ?>">
                  <?php if ($errors->any()) : ?>
                    <div class="alert alert-danger">
                      <ul>
                        <?php $__currentLoopData = $errors->all();
...
<?php echo $__env->make('dashboard.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Users\Donne\PhpstormProjects\OTI de demain\charity\Charity\resources\views/dashboard/dashboardSettings/edit.blade.php ENDPATH**/ ?>