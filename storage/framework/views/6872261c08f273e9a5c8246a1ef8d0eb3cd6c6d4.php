    ...
    <div class="main-content-container container-fluid px-4">
        ...
        <div class="page-header row no-gutters py-4">
            <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
                ...
                <h3 class="page-title"><i class="icon-material-outline-assignment"></i> Projets
                    <a href="<?php echo e(route('dashboardCauses.create')); ?>" class="mb-2 btn btn-success mr-2">
                        <i class="icon-material-outline-add-circle-outline"></i> Ajouter un projet</a>
                </h3>
            </div>
        </div>
        <!-- ================================ dashboard Causes  ========================================================================= -->
            ...
            <div class="col-lg-12 mb-4">
                <div class="card card-small lo-stats h-100">
                    <div class="card-header border-bottom">
                        <h6 class="m-0">Derniers projets</h6>
                            ...
                            <table class="table mb-0">
                                <thead class="py-2 bg-light text-semibold border-bottom">
                                    <tr>
                                        ...
                                        <th class="text-center">Recolté</th>
                                        ...
                                        <tr>
                                            ...
                                            <td class="lo-stats__status">
                                                <div class="d-table mx-auto">
                                                    <?php if(isset($Cause->Category->title)): ?>
                                                        <span
                                                            class="badge badge-pill badge-success"><?php echo e($Cause->Category->title); ?></span>
                                                    <?php else: ?>
                                                        <span class="badge badge-pill badge-danger">Aucune catégorie</span>
                                                    <?php endif; ?>
                                                </div>
                                            </td>
                                            <!-- ================================ dashboard Causes  ========================================================================= -->
                                            ...
                                            <td class="lo-stats__actions">
                                                <div class="btn-group d-table ml-auto" role="group"
                                                    ...
                                                    <a href="<?php echo e(URL::to('dashboard/dashboardCauses')); ?>/<?php echo e($Cause->slug); ?>/edit"
                                                        class="mb-2 btn btn-sm btn-primary">

                                                        <i class="icon-feather-edit-2"></i> Editer</a>
                                                    &nbsp
                                                    <form action="<?php echo e(route('dashboardCauses.destroy', $Cause->id)); ?>"
                        ...
                        <div class="row">
                            ...
                            <div class="col text-right view-report">
                                ...
                                <?php if(COUNT($Causes) != null): ?>
                                    <a>Afficher 10 à <?php echo e(COUNT($Causes)); ?> de <?php echo e(COUNT($Causes)); ?> causes</a>
                                <?php else: ?>
                                    <a>Afficher 10 à 0 de 0 causes</a>
                                <?php endif; ?>
                                <!-- ================================ dashboard Causes  ========================================================================= -->
                            </div>
                        </div>
...
<?php echo $__env->make('dashboard.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Users\Donne\PhpstormProjects\OTI de demain\charity\Charity\resources\views/dashboard/dashboardCauses/index.blade.php ENDPATH**/ ?>