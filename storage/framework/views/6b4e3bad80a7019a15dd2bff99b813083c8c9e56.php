			...
			<div class="row feature_inner">
				<div class="col-lg-4 col-md-6">
					<div class="feature-item">
						...
						<h4>S'instruire et se soutenir</h4>
						<!-- ===============================  Home  ======================================== -->
						<p><?php echo Setting()->content_feature_gr; ?></p>
						<!-- ===============================  Home  ======================================== -->
						<a href="<?php echo e(url('Contact')); ?>" class="primary-btn2">En savoir plus</a>
						<!-- ===============================  Home  ======================================== -->
					</div>
				</div>
				<div class="col-lg-4 col-md-6">
						...
						<div class="card-body">
							...
							<div class="card_inner_body">
								...
								<div class="d-flex justify-content-between raised_goal">
									<!-- ===============================  Home  ======================================== -->
									<p>Recolté: <?php echo $Cause->Raised; ?></p>
									<!-- ===============================  Home  ======================================== -->
								...
								<div class="d-flex justify-content-between donation align-items-center">
									<!-- ===============================  Home  ======================================== -->
									<a href="<?php echo url('Causes'); ?>/<?php echo $Cause->slug; ?>" class="primary-btn">Faire un don</a>
									<!-- ===============================  Home  ======================================== -->
				...
				<div class="col-lg-4 col-md-6 single-blog">
					...
					<div class="single-blog-info">
						...
						<div class="meta-bottom d-flex">
			             ...
			             <?php else: ?>
			             <a class="mr-3"><span class="ti-comments mr-2"></span> Aucun commentaire</a>
			             <?php endif; ?>
						 <a href="<?php echo url('Posts'); ?>/<?php echo $Post->slug; ?>"> <span class="ti-eye mr-2"></span> Voir plus</a>
						</div>
						<!-- ===============================  Home Post ======================================== -->
					</div>
				</div>
...
<?php echo $__env->make('French.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Users\Donne\PhpstormProjects\OTI de demain\charity\Charity\resources\views/French/home.blade.php ENDPATH**/ ?>