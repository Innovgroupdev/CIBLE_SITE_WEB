        ...
        <nav class="navbar navbar-expand-lg navbar-light">
            <div class="container">
                ...
                <a class="navbar-brand" href="<?php echo url('/'); ?>">
                    <img src="<?php echo e(asset(Setting()->LogoPicture)); ?>" style="border-radius: 50%;"
                        style="border-radius: 50%;" alt="" height="96px" width="96px">
                </a>
                <!-- =============================== BASE  ======================================== -->
                ...
                <div class="collapse navbar-collapse justify-content-end align-items-center"
                    ...
                    <ul class="navbar-nav">
                        <!-- =============================== BASE  ======================================== -->
                        <?php $__currentLoopData = Menugermans(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li><a href="<?php echo e(url('')); ?>/<?php echo e($Menu->url); ?>"
                                    target="<?php echo $Menu->target; ?>"><?php echo $Menu->title; ?></a></li>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </ul>
                    <?php if(auth()->guard()->guest()): ?>
                        <!-- =============================== BASE ======================================== -->
                        <a href="<?php echo e(route('login')); ?>" class="genric-btn primary small"><i
                    ...
                    <?php else: ?>
                        ...
                        document.getElementById('logout-form').submit();"
                            class="genric-btn primary small"><i class="icon-feather-log-out"></i> Se déconnecter</a>
                        ...
                        <div class="single-footer-widget tp_widgets">
                            ...
                            <center>
                                <h4 class="footer_title large_title"><img src="<?php echo e(asset(Setting()->LogoPicture)); ?>"
                                        style="border-radius: 50%; text-align: center;width: 50%;" alt="Logo">
                                </h4>
                            </center>
                            <p>
                                <!-- =============================== Setting BASE ======================================== -->
                                <?php echo e(Setting()->about_gr); ?>

                            </p>
                            <!-- =============================== Setting BASE ======================================== -->

                            <p>
                                © Oti De Demain 2022. Tous droits réservés. Design & Code with &hearts; by <a
                                    href="https://nematechgroup.com" target="_blank">Nematech Togo SARL</a>
                            </p>
                            <!-- =============================== Setting BASE ======================================== -->
                        </div>
                    </div>
                   
                    <div class="offset-lg-4 col-lg-3 col-md-6 col-sm-6">
                        <div class="single-footer-widget tp_widgets">
...
<?php /**PATH D:\Users\Donne\PhpstormProjects\OTI de demain\charity\Charity\resources\views/French/layout/main.blade.php ENDPATH**/ ?>