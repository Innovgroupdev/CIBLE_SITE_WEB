    ...
    <header class="default-header">
        <nav class="navbar navbar-expand-lg navbar-light">
            ...
            <div class="collapse navbar-collapse justify-content-end align-items-center" id="navbarSupportedContent">
                <ul class="navbar-nav">
                <!-- =============================== BASE  ======================================== -->
                <?php $__currentLoopData = Menuarabics(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <li><a href="<?php echo e(url('')); ?>/<?php echo e($Menu->url); ?>" target="<?php echo $Menu->target; ?>"><?php echo $Menu->title; ?></a></li>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </ul>
                <?php if(auth()->guard()->guest()): ?>
                <!-- =============================== BASE ======================================== -->
                <a href="<?php echo e(route('login')); ?>" class="genric-btn primary small"><i class=" icon-material-outline-face"></i> <?php echo e(__('تسجيل الدخول')); ?></a>
                <?php else: ?>
                <a href="<?php echo e(route('logout')); ?>" onclick="event.preventDefault();
                document.getElementById('logout-form').submit();" class="genric-btn primary small"><i class="icon-feather-log-in"></i> <?php echo e(__('الخروج')); ?></a>
            ...
            <div class="row section_gap">
                <div class="col-lg-5 col-md-6 col-sm-6">
                    <div class="single-footer-widget tp_widgets">
                        ...
                        <p>
                            <!-- =============================== Setting BASE ======================================== -->
                            <?php echo e(Setting()->about_ar); ?>

                        </p>
                        <!-- =============================== Setting BASE ======================================== -->
                        <P><?php echo e(Setting()->Location); ?></P>
                        <p>
                          حقوق الطبع والنشر & &copy;كل الحقوق محفوظة   <a href="<?php echo e(url('/')); ?>" target="_blank"><?php echo e(Setting()->SiteTitle); ?></a>
                      </p>
                      <!-- =============================== Setting BASE ======================================== -->
                  </div>
              </div>
              <div class="col-md-3">
                <div class="single-footer-widget tp_widgets">
                    <h4 class="footer_title">اللغات</h4>
                   <ul class="languagepicker large roundborders">
                   <a href="<?php echo url('English'); ?>"><li><img src="<?php echo e(asset('assets/img/english.png')); ?>"/>Anglais</li></a>
                    <a href="<?php echo url('French'); ?>"><li><img src="<?php echo e(asset('assets/img/french.png')); ?>"/>Français</li></a>
                    <a href="<?php echo url('arabic'); ?>"><li><img src="<?php echo e(asset('assets/img/arabic.png')); ?>"/>Arabe</li></a>
                     </ul>
                </div> 
            </div>
            <div class="offset-lg-1 col-lg-3 col-md-6 col-sm-6">
                <div class="single-footer-widget tp_widgets">
                    <h4 class="footer_title">اتصل بنا</h4>
                    <div class="ml-5">
                        <p class="sm-head">
...
<?php /**PATH D:\Users\Donne\PhpstormProjects\OTI de demain\charity\Charity\resources\views/arabic/layout/main.blade.php ENDPATH**/ ?>