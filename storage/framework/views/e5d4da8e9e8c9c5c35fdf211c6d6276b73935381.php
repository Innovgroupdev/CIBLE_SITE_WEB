						...
						<div class="container">
							<div class="row">
											...
											<div class="iq-blog-box">
												...
												<div class="iq-blog-image">
													<img width="1200" height="550"
														src="<?php echo e(asset('wp-content/uploads/sites/9/2018/12/blog-1-26-1.jpg')); ?>"
												...
												<div class="iq-blog-detail">
													...
													<div class="blog-title">
														<h5 class="entry-title">
															<a href="<?php echo e(route('detail')); ?>">
																Life Lack Meaning </a>
														</h5>
													</div>
													...
													<div class="blog-button">
														<a class="button pull-left"
															href="<?php echo e(route('detail')); ?>">Voir plus<i class="fa fa-angle-right" aria-hidden="true"></i></a>
													</div>
								...
								<div class="col-lg-4 col-md-5 col-sm-12">
                                    <?php echo $__env->make('partials.blog.aside', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
								</div>
							</div><!-- #row -->
...
<?php echo $__env->make('partials.model', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\projects\CIBLE_SITE_WEB\resources\views/partials/blog/index.blade.php ENDPATH**/ ?>