						...
						<article class="blog_item">
							...
							<div class="blog_details">
								...
								<a class="d-inline-block" href="<?php echo url('Posts'); ?>/<?php echo $Post->slug; ?>">
									<h2><?php echo substr($Post->Title_gr, 0, 190); ?></h2>
								</a>
								<!-- =============================== Posts ======================================== -->
								<p><?php echo substr($Post->body_gr, 0, 190); ?></p>
								<ul class="blog-info-link">
									...
									<?php if (isset($Post->Comments)) : ?>
										<li><a><i class="fa fa-comment-o"></i> <?php echo e(count($Post->Comments)); ?> Bemerkungen</a></li>
									<?php else : ?>
			...
			<div class="col-lg-4">
				<div class="blog_right_sidebar">
					...
					<aside class="single_sidebar_widget popular_post_widget">
						...
						<!-- ===============================  Posts ======================================== -->
						<?php $__currentLoopData = $RentPosts;
						$__env->addLoop($__currentLoopData);
						foreach ($__currentLoopData as $RentPost) : $__env->incrementLoopIndices();
							$loop = $__env->getLastLoop(); ?>
							<div class="media post_item">
								...
								<div class="media-body">
									...
									<a href="<?php echo url('Posts'); ?>/<?php echo $RentPost->slug; ?>">
										<h3><?php echo substr($RentPost->Title_gr, 0, 190); ?></h3>
									</a>
					...
					<aside class="single_sidebar_widget newsletter_widget">
						<div class="fb-page" data-href="<?php echo Setting()->Facebook; ?>" data-tabs="timeline" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true">
							<blockquote cite="<?php echo Setting()->Facebook; ?>" class="fb-xfbml-parse-ignore">
								<a href="<?php echo Setting()->Facebook; ?>">Meteors</a>
							</blockquote>
						</div>
					</aside>
				</div>
...
<?php echo $__env->make('French.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Users\Donne\PhpstormProjects\OTI de demain\charity\Charity\resources\views/French/Posts/index.blade.php ENDPATH**/ ?>