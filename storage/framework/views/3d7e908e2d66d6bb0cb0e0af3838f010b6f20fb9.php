                  ...
                  <div class="form-row mx-4">
                    ...
                    <div class="col-lg-4">
                      ...
                      <div class="edit-user-details__avatar m-auto">
                        ...
                        <img src="<?php echo asset($Settings->LogoPicture); ?>"  style="border-radius: 50%;" alt="Logo">
                        <?php else: ?>
                  ...
                  <div class="form-row mx-4">
                    ...
                    <div class="form-group col-md-4">
                      ...
                      <div class="input-group input-group-seamless">
                        ...
                        <input type="email" class="form-control" id="socialSlack" value="<?php echo e($Settings->Slack); ?>">
                      </div>
                    </div>
                    <!-- ============================================= links Content Start Setting ============================================= -->
                    <div class="form-group col-md-4">
                      ...
                      <div class="input-group input-group-seamless">
                        ...
                        <input type="email" class="form-control" id="socialDribbble" value="<?php echo e($Settings->Dribbble); ?>">
                      </div>
                    </div>
                    <div class="form-group col-md-4">
                    ...
                    <div class="form-group col-md-4">
                      ...
                      <div class="input-group input-group-seamless">
                        ...
                        <input type="email" class="form-control" id="socialGoogle" value="<?php echo e($Settings->Behance); ?>">
                      </div>
                    </div>
                    <div class="form-group col-md-4">
                      ...
                      <div class="input-group input-group-seamless">
                        ...
                        <input type="email" class="form-control" id="socialGoogle" value="<?php echo e($Settings->Digg); ?>">
                      </div>
                    </div>
                    <div class="form-group col-md-4">
                      ...
                      <div class="input-group input-group-seamless">
                        ...
                        <input type="email" class="form-control" id="socialGoogle" value="<?php echo e($Settings->Flickr); ?>">
                      </div>
                    </div>
                    <!-- ============================================= links Content Start Setting ============================================= -->
                    <div class="form-group col-md-4">
                      ...
                      <div class="input-group input-group-seamless">
                        ...
                        <input type="email" class="form-control" id="socialGoogle" value="<?php echo e($Settings->Vimeo); ?>">
                      </div>
                    </div>
                    <div class="form-group col-md-4">
                    ...
                    <div class="form-group col-md-4">
                      ...
                      <div class="input-group input-group-seamless">
                        ...
                        <input type="email" class="form-control" id="socialGoogle" value="<?php echo e($Settings->url_App); ?>">
                      </div>
                    </div>
                  </div>
                  <hr>
              ...
              <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab"> <form class="py-4">
                  ...
                  <div class="form-row mx-4">
                    <div class="col-lg-12">
                     ...
                     <div class="form-group col-md-4">
                      <label for="about_gr">About Site French</label>
                      <textarea style="min-height: 87px;"  class="form-control"><?php echo e($Settings->about_gr); ?></textarea>
                     </div>
                     <div class="form-group col-md-4">
                      <label for="about_en">About Site Arabic</label>
                      <textarea style="min-height: 87px;" class="form-control"><?php echo e($Settings->about_ar); ?></textarea>
                     </div>
                     ...
                     <div class="form-group col-md-4">
                      <!-- ============================================= links Content Start Setting ============================================= -->
                      <label for="about_gr">Title Site French</label>
                      <textarea style="min-height: 87px;"  class="form-control"><?php echo e($Settings->title_home_gr); ?></textarea>
                     </div>
                     <div class="form-group col-md-4">
                      <label for="about_en">Title Site Arabic</label>
                      <textarea style="min-height: 87px;" class="form-control"><?php echo e($Settings->title_home_ar); ?></textarea>
                     </div>
                     <div class="form-group col-md-4">
                     ...
                     <div class="form-group col-md-4">
                      <label for="about_gr">Sub Title Site French</label>
                      <textarea style="min-height: 87px;" class="form-control"><?php echo e($Settings->sub_title_home_gr); ?></textarea>
                     </div>
                     <div class="form-group col-md-4">
                      <label for="about_en">Sub Title Site Arabic</label>
                      <textarea style="min-height: 87px;" class="form-control"><?php echo e($Settings->sub_title_home_ar); ?></textarea>
                     </div>
                     <!-- ============================================= links Content Start Setting ============================================= -->
                     <div class="form-group col-md-4">
                     ...
                     <div class="form-group col-md-4">
                      <label for="about_gr">About French</label>
                      <textarea style="min-height: 87px;" class="form-control"><?php echo e($Settings->title_about_gr); ?></textarea>
                     </div>
                     <div class="form-group col-md-4">
                      <label for="about_en">About Arabic</label>
                      <textarea style="min-height: 87px;" class="form-control"><?php echo e($Settings->title_about_ar); ?></textarea>
                     </div>
                    <div class="form-group col-md-4">
                     ...
                     <!-- ============================================= links Content Start Setting ============================================= -->
                     <div class="form-group col-md-4">
                      <label for="about_gr">Content About French</label>
                      <textarea style="min-height: 87px;" class="form-control"><?php echo e($Settings->content_about_gr); ?></textarea>
                     </div>
                     <div class="form-group col-md-4">
                      <label for="about_en">Content About Arabic</label>
                      <textarea style="min-height: 87px;" class="form-control"><?php echo e($Settings->content_about_ar); ?></textarea>
                     </div>
                     <div class="form-group col-md-4">
                     ...
                     <div class="form-group col-md-4">
                      <label for="about_gr">Content blog French</label>
                      <textarea style="min-height: 87px;" class="form-control"><?php echo e($Settings->content_blog_gr); ?></textarea>
                     </div>
                     <!-- ============================================= links Content Start Setting ============================================= -->
                     <div class="form-group col-md-4">
                      <label for="about_en">Content blog Arabic</label>
                      <textarea style="min-height: 87px;" class="form-control"><?php echo e($Settings->content_blog_ar); ?></textarea>
                     </div>
                     <div class="form-group col-md-4">
                     ...
                     <div class="form-group col-md-4">
                      <label for="about_gr">Content Feature French</label>
                      <textarea style="min-height: 87px;" class="form-control"><?php echo e($Settings->content_feature_gr); ?></textarea>
                     </div>
                     <div class="form-group col-md-4">
                      <!-- ============================================= links Content Start Setting ============================================= -->
                      <label for="about_en">Content Feature Arabic</label>
                      <textarea style="min-height: 87px;" class="form-control"><?php echo e($Settings->content_feature_ar); ?></textarea>
                     </div>
                     <div class="form-group col-md-4">
                     ...
                     <div class="form-group col-md-4">
                      <label for="about_gr">Content Two Feature French</label>
                      <textarea style="min-height: 87px;" class="form-control"><?php echo e($Settings->content_feature_two_gr); ?></textarea>
                     </div>
                     <div class="form-group col-md-4">
                      <!-- ============================================= links Content Start Setting ============================================= -->
                      <label for="about_en">Content Two Feature Arabic</label>
                      <textarea style="min-height: 87px;" class="form-control"><?php echo e($Settings->content_feature_two_ar); ?></textarea>
                     </div>
                     <div class="form-group col-md-4">
                     ...
                     <div class="form-group col-md-4">
                      <label for="about_gr">Content Three Feature French</label>
                      <textarea style="min-height: 87px;" class="form-control"><?php echo e($Settings->content_feature_three_gr); ?></textarea>
                     </div>
                     <div class="form-group col-md-4">
                      <label for="about_en">Content Three Feature Arabic</label>
                      <textarea style="min-height: 87px;" class="form-control"><?php echo e($Settings->content_feature_three_ar); ?></textarea>
                     </div>
                     <!-- ============================================= links Content Start Setting ============================================= -->
                      </div>
                    </div>
...
<?php echo $__env->make('dashboard.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Users\Donne\PhpstormProjects\OTI de demain\charity\Charity\resources\views/dashboard/dashboardSettings/index.blade.php ENDPATH**/ ?>