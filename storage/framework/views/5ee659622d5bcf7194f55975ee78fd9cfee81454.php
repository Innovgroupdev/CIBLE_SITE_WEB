            ...
            <div class="col-lg-9 col-md-12">
                ...
                <div class="card card-small mb-3">
                    <div id="form-container" class="card-body">
                        ...
                        <form action="<?php echo e(route('dashboardCauses.store')); ?>" method="POST" role="form"
                    ...
                    <div class='card-body p-0'>
                        <ul class="list-group list-group-flush">
                            <div class="edit-post-details__avatar m-auto">
                                <img id="viewer"
                                    src="<?php echo e(asset('dashboardassets/images/content-management/cover.png')); ?>"
                                    alt="User Avatar">
...
<?php echo $__env->make('dashboard.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\cible_stie_web\CIBLE_SITE_WEB\resources\views/dashboard/dashboardCauses/create.blade.php ENDPATH**/ ?>