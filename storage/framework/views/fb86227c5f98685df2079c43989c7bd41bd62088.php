            ...
            <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
                ...
                <h3 class="page-title"><i class=" icon-feather-file-text"></i> Publicité
                    <a href="<?php echo e(route('dashboardGalleres.create')); ?>" class="mb-2 btn btn-success mr-2">
                        <i class="icon-material-outline-add-circle-outline"></i> Ajouter une publicité</a>
                </h3>
            </div>
        </div>
        <!-- ====================== links Galleres Content Start =============================================== -->
            ...
            <div class="col-lg-12 mb-4">
                <div class="card card-small lo-stats h-100">
                    <div class="card-header border-bottom">
                        <h6 class="m-0">Dernières publicités</h6>
...
<?php echo $__env->make('dashboard.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Users\Donne\AndroidStudioProjects\INNOV GROUP\CIBLE_ADMIN\resources\views/dashboard/dashboardGalleres/index.blade.php ENDPATH**/ ?>