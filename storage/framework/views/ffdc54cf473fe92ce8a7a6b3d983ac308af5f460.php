...
<link rel='stylesheet' id='vc_openiconic-css'
      href="<?php echo e(asset('wp-content/plugins/js_composer/assets/css/lib/vc-open-iconic/vc_openiconic.min31dc.css?ver=6.6.0')); ?>"
      media='all' />
<link rel='stylesheet' id='vc_typicons-css'
      href="<?php echo e(asset('wp-content/plugins/js_composer/assets/css/lib/typicons/src/font/typicons.min31dc.css?ver=6.6.0')); ?>"
      media='all' />
<link rel='stylesheet' id='vc_entypo-css'
      href="<?php echo e(asset('wp-content/plugins/js_composer/assets/css/lib/vc-entypo/vc_entypo.min31dc.css?ver=6.6.0')); ?>" media='all' />
<link rel='stylesheet' id='vc_linecons-css'
      href="<?php echo e(asset('wp-content/plugins/js_composer/assets/css/lib/vc-linecons/vc_linecons_icons.min31dc.css?ver=6.6.0')); ?>"
      media='all' />
<script src="<?php echo e(asset('wp-content/plugins/yith-woocommerce-wishlist/assets/js/jquery.selectBox.min7359.js?ver=1.2.0')); ?>"
        id='jquery-selectBox-js'></script>
<script src="<?php echo e(asset('wp-content/plugins/woocommerce/assets/js/prettyPhoto/jquery.prettyPhoto.min005e.js?ver=3.1.6')); ?>"
...
<script src="<?php echo e(asset('wp-content/plugins/yith-woocommerce-wishlist/assets/js/jquery.yith-wcwl.min7ee6.js?ver=3.0.23')); ?>"
        id='jquery-yith-wcwl-js'></script>
<script src="<?php echo e(asset('wp-includes/js/dist/vendorwppolyfill.min89b1.js?ver=7.4.4')); ?>" id='wp-polyfill-js'></script>
...
<script src="<?php echo e(asset('wp-content/plugins/contact-form-7/includes/js/indexc225.js?ver=5.4.1')); ?>" id='contact-form-7-js'></script>
<script src="<?php echo e(asset('wp-content/plugins/woocommerce/assets/js/js-cookie/js.cookie.min6b25.js?ver=2.1.4')); ?>"
...
<script src="<?php echo e(asset('wp-content/plugins/woocommerce/assets/js/frontend/woocommerce.min7e15.js?ver=5.5.4')); ?>"
...
<script src="<?php echo e(asset('wp-content/plugins/woocommerce/assets/js/frontend/cart-fragments.min7e15.js?ver=5.5.4')); ?>"
        id='wc-cart-fragments-js'></script>
<script src="<?php echo e(asset('wp-content/themes/appino/assets/js/bootstrap.min5152.js?ver=1.0')); ?>" id='bootstrap-js'></script>
<script src="<?php echo e(asset('wp-content/themes/appino/assets/js/owl.carousel.min5152.js?ver=1.0')); ?>" id='carousel-js'></script>
<script src="<?php echo e(asset('wp-content/themes/appino/assets/js/counter/jquery.countTo5152.js?ver=1.0')); ?>"
        id='jquery-counter-js'></script>
<script src="<?php echo e(asset('wp-content/themes/appino/assets/js/jquery.appear5152.js?ver=1.0')); ?>" id='jquery-appear-js'></script>
<script src="<?php echo e(asset('wp-content/themes/appino/assets/js/magnific-popup/jquery.magnific-popup.min5152.js?ver=1.0')); ?>"
        id='jquery-magnific-js'></script>
<script src="<?php echo e(asset('wp-content/themes/appino/assets/js/skrollr5152.js?ver=1.0')); ?>" id='skrollr-js'></script>
<script src="<?php echo e(asset('wp-content/themes/appino/assets/js/wow.min5152.js?ver=1.0')); ?>" id='wow-js'></script>
<script src="<?php echo e(asset('wp-content/themes/appino/woocommerce/assets/wishlist5152.js?ver=1.0')); ?>" id='wishlist-js'></script>
<script src="<?php echo e(asset('wp-content/themes/appino/assets/js/jquery.countdown.min5152.js?ver=1.0')); ?>"
        id='jquery-countdown-js'></script>
<script src="<?php echo e(asset('wp-content/themes/appino/assets/js/appino-custom5152.js?ver=1.0')); ?>" id='appino-custom-js'></script>
<script src="<?php echo e(asset('wp-includes/jswpembed.mincfaa.js?ver=5.7.6')); ?>" id='wp-embed-js'></script>
<script src="<?php echo e(asset('wp-content/plugins/js_composer/assets/js/dist/js_composer_front.min31dc.js?ver=6.6.0')); ?>"
        id='wpb_composer_front_js-js'></script>
<script src="<?php echo e(asset('wp-content/plugins/js_composer/assets/lib/bower/skrollr/dist/skrollr.min31dc.js?ver=6.6.0')); ?>"
        id='vc_jquery_skrollr_js-js'></script>
<script src="<?php echo e(asset('wp-content/themes/appino/assets/js/particles/particles.min5152.js?ver=1.0')); ?>"
        id='jquery-particles-js'></script>
<script src="<?php echo e(asset('wp-content/themes/appino/assets/js/particles/app5152.js?ver=1.0')); ?>" id='jquery-app-js'></script>

<!-- === back-to-top End === -->
</body>
</html>
<?php /**PATH C:\wamp64\www\projects\CIBLE_SITE_WEB\resources\views/partials/footer.blade.php ENDPATH**/ ?>