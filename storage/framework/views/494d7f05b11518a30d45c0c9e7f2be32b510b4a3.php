            ...
            <div class="col-sm-12">
                <nav class="navbar navbar-expand-lg navbar-light">
                    <a class="navbar-brand" href="#">
                        <img class="img-fluid" src="<?php echo e(asset("/wp-content/themes/appino/assets/images/logo.png")); ?>"
                             alt="appino">
                    </a>
                            ...
                            <div class="menu-top-menu-container">
                                <ul id="top-menu" class="menu">
                                    ...
                                    <li id="menu-item-1041"
                                        ...
                                        <a href="<?php echo e(url('/')); ?>#faq">FAQ</a></li>
                                    <!-- <li id="menu-item-556"
...
<?php /**PATH C:\wamp64\www\projects\CIBLE_SITE_WEB\resources\views/partials/header.blade.php ENDPATH**/ ?>