            ...
            <div class="col-lg-9 col-md-12">
                <div class="card card-small mb-3">
                    <div id="form-container" class="card-body">
                        <!-- ================================================ Page dashboard Ads ========================================================= -->
                        <form action="<?php echo e(route('dashboardAds.store')); ?>" method="POST" role="form"
                            enctype="multipart/form-data" class="add-new-post" id="FormID">
                            <?php echo csrf_field(); ?>
                            ...
                            <!-- =================== Page dashboard Ads  select ====================== -->
                            <input class="form-control form-control-lg mb-3" type="text" placeholder="Your Name"
                                name="name">
                            <input class="form-control  form-control-lg mb-3" type="text" placeholder="Your Display Name"
                                name="displayname">
                                ...
                                <div class="col-2">
                                    <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist"
                                        ...
                                        <a class="nav-link active" id="v-pills-home-tab" data-toggle="pill"
                                            ...
                                            <i class="icon-line-awesome-image"></i> Image
                                        </a>
                                    ...
                                    <div class="tab-content" id="v-pills-tabContent">
                                        <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel"
                                            ...
                                            <input class="form-control form-control-lg mb-3" type="text"
                                                placeholder="Your Url Image" name="url">
                                            <div class="card card-small edit-user-details mb-4">
                                                <div class="card-header p-0" style="border-radius: .375rem;">
                                                    <div class="edit-user-details__bg">
                                                        <!-- =================== Page dashboard Ads  AdSense ====================== -->
                                                        <img src="<?php echo e(asset('dashboardassets/images/content-management/3.png')); ?>"
                                                            alt="User Details Background Image">
                                                        <label class="edit-user-details__change-background">
                                                            <i class="icon-material-outline-add-a-photo mr-1"
                                                                style="font-size: 22px;top: 3px;"></i> Change Image
...
<?php echo $__env->make('dashboard.layouts.postmain', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Users\Donne\PhpstormProjects\OTI de demain\charity\Charity\resources\views/dashboard/dashboardAds/create.blade.php ENDPATH**/ ?>