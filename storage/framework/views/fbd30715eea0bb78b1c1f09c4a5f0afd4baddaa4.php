        ...
        <div class="page-header row no-gutters py-4">
            <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
                ...
                <h3 class="page-title"><i class="icon-feather-tv"></i> Ads
                    <a href="<?php echo e(route('dashboardAds.create')); ?>" class="mb-2 btn btn-success mr-2"><i
                            class="icon-material-outline-add-circle-outline"></i> Add Ads</a>
                </h3>
            </div>
        </div>
        <!-- ============================================================= Content Start ============================================================= -->
                                ...
                                <tbody>
                                    ...
                                    <?php $__currentLoopData = $advertisers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $advertiser): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <!-- ================================ advertisers Content Start ======================== -->
                                            <td class="lo-stats__total text-center text-success"><?php echo $advertiser->type; ?>

                                            </td>
                                            <td class="lo-stats__status">
                                                <div class="d-table mx-auto">
                                                    <span
                                                        class="badge badge-pill badge-success"><?php echo $advertiser->Location; ?></span>
                                                </div>
                                            </td>
                                            <!-- ================================ advertisers Content Start ======================== -->
                                            <td class="lo-stats__actions">
                                                <div class="btn-group d-table ml-auto" role="group"
                                                    ...
                                                    <a href="<?php echo e(URL::to('dashboard/Ads')); ?>/<?php echo e($advertiser->name); ?>/edit"
                                                        class="mb-2 btn btn-sm btn-primary">
                                                        <i class="icon-feather-edit-2"></i> Edit</a>
                                                    <!-- ================================ delete advertisers Content Start ======================== -->
                                                    <form action="<?php echo e(route('dashboardAds.destroy', $advertiser->id)); ?>"
                        ...
                        <div class="row">
                            ...
                            <div class="col text-right view-report">
                                <?php if(COUNT($advertisers) != null): ?>
                                    <a>Afficher 10 to <?php echo e(COUNT($advertisers)); ?> of <?php echo e(COUNT($advertisers)); ?>

                                        advertisers</a>
                                <?php else: ?>
                                    <a>Afficher 10 to 0 of 0 advertisers</a>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('dashboard.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Users\Donne\PhpstormProjects\OTI de demain\charity\Charity\resources\views/dashboard/dashboardAds/index.blade.php ENDPATH**/ ?>