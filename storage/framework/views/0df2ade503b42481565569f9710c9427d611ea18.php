...
<body class="h-100">
                        ...
                        <a class="navbar-brand w-100 mr-0" href="<?php echo e(url('/')); ?>" style="line-height: 25px;"
                            ...
                            <div class="d-table m-auto">
                                ...
                                <img id="main-logo" class="d-inline-block align-top mr-1 rounded-circle20"
                                    src="<?php echo e(asset(Setting()->LogoPicture)); ?>" style="border-radius: 50%;" alt="Name" height="50" width='50'>
                                <!-- ============================================= Name SiteTitle ============================================= -->
            ...
            <main class="main-content col-lg-10 col-md-9 col-sm-12 p-0 offset-lg-2 offset-md-3">
                    ...
                    <nav class="navbar d-flex justify-content-end navbar-light flex-md-nowrap p-0">
                        <ul class="navbar-nav border-left flex-row ">
                            <li class="nav-item border-right dropdown notifications">
                                <!-- ============================================= Name SiteTitle ============================================= -->
                                <a class="nav-link nav-link-icon text-center" href="<?php echo e(route('logout')); ?>" onclick="event.preventDefault();
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-small">
                                    ...
                                    <a class="dropdown-item" href="<?php echo e(url('dashboard/dashboardSettings')); ?>">
                                        <i class="icon-material-outline-settings"></i> Réglages</a>
                                    <!-- ============================================= Name SiteTitle ============================================= -->
                ...
                <footer class="main-footer d-flex p-2 px-3 bg-white border-top">
                    <span class="copyright ml-auto my-auto mr-2">Copyright © 2022
                        <a href="https://nematechgroup.com" target="_blank" rel="nofollow">Nematech Togo SARL</a>
    ...
    <!-- ============================================= dashboard javascript ============================================= -->
    <script type="text/javascript" src="<?php echo e(asset('dashboardassets/froala/js/plugins/code_beautifier.min.js')); ?>">
    </script>
    <!-- ============================================= dashboard javascript ============================================= -->
    ...
    <!-- ============================================= dashboard javascript ============================================= -->
    <script type="text/javascript" src="<?php echo e(asset('dashboardassets/froala/js/plugins/paragraph_format.min.js')); ?>">
    </script>
    <!-- ============================================= dashboard javascript ============================================= -->
    <script type="text/javascript" src="<?php echo e(asset('dashboardassets/froala/js/plugins/paragraph_style.min.js')); ?>">
    </script>
    <!-- ============================================= dashboard javascript ============================================= -->
...
<?php /**PATH D:\Users\Donne\AndroidStudioProjects\INNOV GROUP\CIBLE_ADMIN\resources\views/dashboard/layouts/postmain.blade.php ENDPATH**/ ?>