...
<?php if ($message = Session::get('Delete')) : ?>
  <div class="alert alert-danger alert-dismissible fade show mb-0" role="alert">
    ...
    <i class="icon-material-outline-check mx-2"></i>
    <strong>Delete!</strong> <?php echo e($message); ?>
  </div>
<?php endif; ?>
<!-- ====================== links Menu Content Start store =============================================== -->
            ...
            foreach ($__currentLoopData as $Menu) : $__env->incrementLoopIndices();
              ...
              <div class="tab-pane fade" id="<?php echo e($Menu->name); ?>" role="tabpanel" aria-labelledby="<?php echo e($Menu->name); ?>-tab">
                <div class="py-4 tab-content" id="myTabContent">
                  ...
                  <!-- ====================== links Menu Content Start store =============================================== -->
                  <?php $__currentLoopData = $Menu->menu_items;
                  $__env->addLoop($__currentLoopData);
...
<?php echo $__env->make('dashboard.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Users\Donne\PhpstormProjects\OTI de demain\charity\Charity\resources\views/dashboard/dashboardMenus/index.blade.php ENDPATH**/ ?>