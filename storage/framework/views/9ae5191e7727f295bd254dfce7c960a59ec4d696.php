  ...
  <div class="main-content-container container-fluid px-4">
    ...
    <div class="page-header row no-gutters py-4">
      <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
        ...
        <h3 class="page-title"><i class=" icon-feather-user-plus"></i> Utilisateurs
          <a href="<?php echo e(route('dashboardUsers.create')); ?>" class="mb-2 btn btn-success mr-2">
            <i class="icon-material-outline-add-circle-outline"></i> Ajouter un utilisateur</a>
          </h3>
        </div>
      </div>
      <!-- ============================================= links Content Start User ============================================= -->
        ...
        <div class="col-lg-12 mb-4">
          <div class="card card-small lo-stats h-100">
            <div class="card-header border-bottom">
              <h6 class="m-0">Derniers utilisateurs</h6>
              ...
              <div class="container-fluid px-0">
                <table class="table mb-0">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="lo-stats__status">
                        <div class="d-table mx-auto">
                          ...
                          <?php else: ?>
                          <span class="badge badge-pill badge-info">Utilisateur</span>
                          <?php endif; ?>
                        </div>
                      </td>
                      <!-- ============================================= links Content Start User ============================================= -->
                    ...
                    <a href="<?php echo e(URL::to('dashboard/dashboardUsers')); ?>/<?php echo e($User->name); ?>/edit" class="mb-2 btn btn-sm btn-primary"><i class="icon-feather-edit-2"></i> Editer</a>
                    &nbsp
                    <form action="<?php echo e(route('dashboardUsers.destroy',$User->id)); ?>" method="POST" files="true" style="display: inline-block;">
                            <?php echo csrf_field(); ?>
                            <?php echo method_field('DELETE'); ?>
                            <button class="mb-2 btn btn-sm btn-danger" type="submit"><i class="icon-material-outline-delete"></i> Supprimer</button>
                          </form>
                        </div>
                      </td>
                    </tr>
              ...
              <div class="row">
                <div class="col">
                  ...
                  <div class="col text-right view-report">
                    ...
                    <a>Afficher 10 à <?php echo e(COUNT($Users)); ?> de <?php echo e(COUNT($Users)); ?> utilisateurs</a>
                    <?php else: ?>
                    <a>Afficher 10 à 0 de 0 utilisateurs</a>
                    <?php endif; ?>
                    <!-- ============================================= links Content Start User ============================================= -->
                  </div>
              </div>
...
<?php echo $__env->make('dashboard.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Users\Donne\PhpstormProjects\OTI de demain\charity\Charity\resources\views/dashboard/dashboardUsers/index.blade.php ENDPATH**/ ?>