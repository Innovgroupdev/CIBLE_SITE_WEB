        ...
        <nav class="navbar navbar-expand-lg navbar-light">
            <div class="container">
                ...
                <div class="collapse navbar-collapse justify-content-end align-items-center" id="navbarSupportedContent">
                    <ul class="navbar-nav">
                        <!-- =============================== BASE  ======================================== -->
                        <?php $__currentLoopData = Menugermans();
                    ...
                    <?php if (auth()->guard()->guest()) : ?>
                        <!-- =============================== BASE ======================================== -->
                        <a href="<?php echo e(route('login')); ?>" class="genric-btn primary small"><i class=" icon-material-outline-face"></i> <?php echo e(__('Anmeldung')); ?></a>
                    <?php else : ?>
                        <a href="<?php echo e(route('logout')); ?>" onclick="event.preventDefault();
                document.getElementById('logout-form').submit();" class="genric-btn primary small"><i class="icon-feather-log-in"></i> <?php echo e(__('Ausloggen')); ?></a>
                ...
                <div class="row section_gap">
                    <div class="col-lg-5 col-md-6 col-sm-6">
                        <div class="single-footer-widget tp_widgets">
                            ...
                            <p>
                                Copyright &copy; Alle Rechte vorbehalten <a href="<?php echo e(url('/')); ?>" target="_blank"><?php echo e(Setting()->SiteTitle); ?></a>
                            </p>
                            <!-- =============================== Setting BASE ======================================== -->
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="single-footer-widget tp_widgets">
                            ...
                            <ul class="languagepicker large roundborders">
                                <a href="<?php echo url('English'); ?>">
                                    <li><img src="<?php echo e(asset('assets/img/english.png')); ?>" />English</li>
                                </a>
                                <a href="<?php echo url('French'); ?>">
                                    <li><img src="<?php echo e(asset('assets/img/german.png')); ?>" />French</li>
                                </a>
                                <a href="<?php echo url('arabic'); ?>">
                                    <li><img src="<?php echo e(asset('assets/img/arabic.png')); ?>" />Arabic</li>
                                </a>
                            </ul>
                        </div>
                    </div>
