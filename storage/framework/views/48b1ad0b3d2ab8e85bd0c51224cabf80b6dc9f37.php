    ...
    <div class="main-content-container container-fluid px-4">
        ...
        <div class="page-header row no-gutters py-4">
            <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
                ...
                <h3 class="page-title"><i class=" icon-feather-file-text"></i> Publicité
                    <a href="<?php echo e(route('dashboardGalleres.create')); ?>" class="mb-2 btn btn-success mr-2">
                        <i class="icon-material-outline-add-circle-outline"></i> Ajouter à la galerie</a>
                </h3>
            </div>
        </div>
        <!-- ====================== links Galleres Content Start =============================================== -->
            ...
            <div class="col-lg-12 mb-4">
                <div class="card card-small lo-stats h-100">
                    <div class="card-header border-bottom">
                        <h6 class="m-0">Derniers de la galerie</h6>
                                        ...
                                        <tr>
                                            ...
                                            <td class="lo-stats__actions">
                                                <div class="btn-group d-table ml-auto" role="group"
                                                    ...
                                                    <form action="<?php echo e(route('dashboardGalleres.destroy', $Gallery->id)); ?>"
                        ...
                        <div class="row">
                            ...
                            <div class="col text-right view-report">
                                ...
                                <?php if(COUNT($Galleres) != null): ?>
                                    <a>Afficher 10 à <?php echo e(COUNT($Galleres)); ?> de <?php echo e(COUNT($Galleres)); ?> images</a>
                                <?php else: ?>
                                    <a>Afficher 10 à 0 de 0 images</a>
                                <?php endif; ?>
                                <!-- ====================== links Galleres Content Start =============================================== -->
                            </div>
                        </div>
...
<?php echo $__env->make('dashboard.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Users\Donne\PhpstormProjects\OTI de demain\charity\Charity\resources\views/dashboard/dashboardGalleres/index.blade.php ENDPATH**/ ?>
